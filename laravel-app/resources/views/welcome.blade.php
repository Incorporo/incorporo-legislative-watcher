...
<body class="antialiased bg-black text-white">
    <div class="relative min-h-screen">
        <!-- Navigation Bar -->
        <nav class="absolute top-0 w-full z-50 border-b border-white border-opacity-10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-6">
                    ...
                    <div class="flex items-center space-x-4">
                        @auth
                            <a href="{{ route('dashboard') }}" class="text-gray-300 hover:text-white px-3 py-2 transition">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}" class="text-gray-300 hover:text-white px-3 py-2 transition">Log in</a>
                            <a href="{{ route('register') }}" class="ml-4 px-6 py-2.5 bg-white text-black rounded-xl hover:bg-gray-100 font-semibold transition">Register</a>
                        @endauth
                    </div>
                </div>
            </div>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            <div class="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
                <div class="text-center">
                    <div class="inline-flex items-center px-4 py-2 rounded-full bg-white bg-opacity-10 mb-8 backdrop-blur-sm border border-white border-opacity-20">
                    ...
                    <h1 class="text-5xl font-bold tracking-tight sm:text-7xl">
                        Monitor Romanian<br/>Legislative Activity
                    </h1>
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="{{ route('bills.index') }}" class="rounded-xl bg-white px-8 py-3.5 text-base font-semibold text-black hover:bg-gray-100 transition">
                            Browse Bills
                        </a>
                        <a href="{{ route('legislators.index') }}" class="text-base font-semibold leading-6 text-white hover:text-gray-300 transition">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8 pb-24">
            <div class="mx-auto max-w-2xl lg:text-center mb-16">
                <h2 class="text-base font-semibold leading-7 text-gray-400 uppercase tracking-wider">Transparency</h2>
            ...
            <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
                <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-8 lg:max-w-none lg:grid-cols-3">
                    <!-- Feature 1 -->
                    <div class="flex flex-col bg-white bg-opacity-5 p-6 rounded-2xl border border-white border-opacity-10 hover:bg-opacity-10 transition-all">
                        <dt class="flex items-center gap-x-3 text-base font-semibold leading-7">
                            <svg class="h-5 w-5 flex-none text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
